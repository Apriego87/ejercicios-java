...
public class Main {
	...
	public static void main(String[] args) {
		...
		b.mostrarCuentas();
		System.out.println("");
		System.out.println(b.borrarCuenta(new Cuenta(20, "Clara Cirac", 22000)));
		/* System.out.println(b.borrarCuentaPorNumero(40));
		b.mostrarCuentas();
		System.out.println(b.contieneCuentaMejorado(new Cuenta(40, "Luis Aldea", 19000))); 
